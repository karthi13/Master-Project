//
// Generated file, do not edit! Created by nedtool 5.0 from veins/modules/application/platooning/messages/UnicastMessage.msg.
//
...
UnicastMessage::UnicastMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->destination = 0;
    this->source = 0;
